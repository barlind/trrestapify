...
export type RestapifyErrorCallbackParam = { error: RestapifyErrorName; message?: string }
...
export type JsonRouteFileContent = JsonCompatible<{ '#body'?: Json; '#header'?: Json }>
